            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="<?= base_url('Admin/login'); ?>" method="post" novalidate>
                    ...
                    <div class="form-group">
                      ...
                      <?php endif;?>
                      <?php if($unmatch_email): ?>
                          <small class="text-danger"> <?= $unmatch_email;?> </small>
                        <?php endif;?>
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="pass"
                        id="InputPassword" aria-describedby="passwordHelp" placeholder="Enter Password">
                      <?php if($validation) :?>
                          <small class="text-danger"> <?= $validation->getError('pass');?> </small>
                      <?php endif;?>
                      <?php if($unmatch_password):?>
                          <small class="text-danger"> <?= $unmatch_password;?> </small>
                        <?php endif;?>
                    </div>
